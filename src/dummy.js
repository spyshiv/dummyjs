...
(function () {
    ...
    function generateText(length) {
        const wordsArr = DUMMY_WORDS_ARR;
        let text = "";
    ...
    function generateParagraphs(numParagraphs, element) {
        let text = "";
    ...
    function generateSentences(numSentences, element) {
        let text = "";
    ...
    function generateWords(numWords, element) {
        const text = generateText(numWords);
        element.innerHTML = text;
    }
    ...
    function init() {
        ...
        for (let i = 0; i < len; i++) {
            ...
            switch (type.toLowerCase()) {
                case "p":
                    generateParagraphs(parseInt(num, 10), element);
                    break;
                case "s":
                    generateSentences(parseInt(num, 10), element);
                    break;
                case "w":
                    generateWords(parseInt(num, 10), element);
                    break;
                default:
